...
class MainWindow(QMainWindow):
    def __init__(self, parent=None):
       ...
       # Robot data
        ...
        # Use QSplitter to separate top layout and camera
        splitter = QSplitter(QtCore.Qt.Vertical)
        top_widget = QWidget()
        top_widget.setLayout(top_layout)
        splitter.addWidget(top_widget)
        splitter.addWidget(self.graphicsView)
        splitter.setStretchFactor(0, 1)  # Top part stretches less
        splitter.setStretchFactor(1, 2)  # Camera feed stretches more
    ...
    def obstacle_callback(self, msg):
        ...
        if obstacle_code == 1:
            ...
            self.obstacle_display.setText("No obstacle or unknown code")
